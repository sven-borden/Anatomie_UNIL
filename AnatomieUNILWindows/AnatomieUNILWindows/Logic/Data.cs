...
namespace Logic
{
	public class Data
	{
		...
		public static readonly string[,] cuisse = new string[,]{
			...
			{"muscle grand adducteur faisceau supérieur (cuisse)", "Branche de l'ischion", "Lèvre médial de la ligne âpre du fémur", "N. obturateur", "Artère circonflexe médiale, artères perforantes, artère obturatrice, branche de l'artère poplitée"},
