...
namespace Anatomie_UNIL
{
    ...
    /// </summary>
    public sealed partial class Tout : Page
    {
        ...
        public Tout()
        {
            ...
            SystemNavigationManager.GetForCurrentView().BackRequested += Tout_BackRequested; SystemNavigationManager.GetForCurrentView().AppViewBackButtonVisibility = AppViewBackButtonVisibility.Visible;

            settings = new WriteTo();
            listesPartie = new Partie("Tout");
        ...
        private void Tout_BackRequested(object sender, BackRequestedEventArgs e)
        {
